...
@Singleton
public class SolvableItemService {

    private static final String TAG = SolvableItemService.class.getSimpleName();
    ...
    @Inject
    public SolvableItemService(Property property, SyntactService syntactService) {
