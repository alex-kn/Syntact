...
public class SolvablePhrasesManagement {
    ...
    public SolvablePhrasesManagement() {

        solvablePhrasesLiveData.addSource(PhraseManagement.getInstance().getPhrases(), this::handleNewPhrases);
    }
    ...
    public boolean solvePhrase(SolvablePhrase solvablePhrase, Letter letter) {
        ...
        if (newSolvablePhrase.isSolved()) {
            PhraseManagement.getInstance().solvePhrase(solvablePhrase.getId());
        }
